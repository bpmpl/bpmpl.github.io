...
<head>
    ...
    <?php
                    ...
                    $getmessageresult=mysqli_query($db,$getmessage) or die("account no couldnt be found3!!");   
                    $messageresult=mysqli_query($db,$message) or die("account no couldnt be found4!!"); 
                    $messageallresult=mysqli_query($db,$messageall) or die("account no couldnt be found5!!");   
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="color:#1f61db;">
                                    <span class="fa fa-sort-amount-asc"></span> User Details</h3>
                    ...
                    <div class="col-md-">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="color:#1f61db;">
                                    <span class="fa fa-mail-reply-all"></span> User ID Details</h3>
                                <ul class="panel-controls">
                                    <li>
                                        <a href="#" class="panel-collapse">
                                            <span class="fa fa-angle-down"></span>
                                ...
                                <table class="table datatable ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $row2['cust_id']?>
                                            </td>
                                            <td>
                                                <?php echo $row2['acc_id']?>
                                            </td>
                                            <td>
                                                <?php echo $row2['cust_type']?>
                                            </td>
                                            <td>
                                                <?php echo $row2['acc_type']?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
